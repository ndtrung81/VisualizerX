...
void CVisualizer_XView::print3DcolorVertex(GLint size, GLint* count, GLfloat* buffer)
{
	int i;
...
void CVisualizer_XView::printBuffer(GLint size, GLfloat * buffer)
{
	GLint count;
	int token, nvertices;
...
GLfloat* CVisualizer_XView::spewPrimitiveEPS(FILE* file, GLfloat* loc)
{
	int token;
	int nvertices, i;
...
void CVisualizer_XView::spewUnsortedFeedback(FILE * file, GLint size, GLfloat * buffer)
{
	GLfloat *loc, *end;
...
void CVisualizer_XView::spewSortedFeedback(FILE* file, GLint size, GLfloat* buffer)
{
	int token;
	GLfloat *loc, *end;
	Feedback3Dcolor *vertex;
...
void CVisualizer_XView::spewWireFrameEPS(FILE * file, int doSort, GLint size, GLfloat * buffer, char *creator)
{
...
void CVisualizer_XView::outputEPS(int size, int doSort, char *filename)
{
